      ...
      <div className="flex flex-1 overflow-hidden p-4 bg-zinc-950">
        <div className="flex-1 flex flex-col rounded-xl overflow-hidden border border-zinc-800 shadow-2xl">
          ...
          <div className="flex-1 overflow-hidden relative">
            ...
            <div
              className={`absolute inset-0 p-4 ${activeTab === "input" ? "block" : "hidden"}`}
            >
              <textarea
                value={input}
            ...
            <div
              className={`absolute inset-0 p-4 ${activeTab === "output" ? "block" : "hidden"}`}
            >
          ...
          <div className="flex items-center justify-between px-4 py-2 border-t border-zinc-800 bg-zinc-900">
            ...
            <button
              onClick={runCode}
              disabled={running}
              className="flex items-center gap-2 px-5 py-1.5 bg-[#75B06F] hover:bg-[#6d9a62] disabled:opacity-50 disabled:cursor-not-allowed text-white text-xs font-semibold rounded-md transition-colors"
            >
